  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center mb-6">
        <h2 className="font-lato tracking-wide text-2xl mt-4 md:text-3xl font-bold text-white">
          Welding
        </h2>
        <p className="font-lato tracking-wide mb-6">Services</p>
        <img className="mb-20 h-[80px] md:h-[150px]" src={WELDING} alt="" />
      </div>
      <motion.div 
          ...
          <Link id="services" to={"/weilding-work"} className="font-semibold text-sm md:text-base">Look Inside</Link>
