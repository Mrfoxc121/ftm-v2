    ...
    >
      <div className="flex flex-col lg:flex-row w-full">
        <div className="lg:w-1/2 flex justify-center items-center">
          <img src={MECHANIC} className="h-[200px] md:h-[300px]" alt="Mechanic" />
        </div>
        ...
        <div className="lg:w-1/2 flex flex-col justify-between items-start px-6 text-slate-100 my-10">
          <div>
            ...
            {showMore && (
              <span className="text-sm text-slate-300 leading-6 mb-10">
                ...
                at its best, giving you peace of mind every time you drive.
              </span>
            )}
            <button
          ...
          >
            <Link id="services" to="/essential-maintenance" className="font-semibold text-sm md:text-base">
              Look Inside
            </Link>
